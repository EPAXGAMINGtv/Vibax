...
public class MoveHandler extends AuthenticatedHandler implements HttpHandler {

    public MoveHandler(String passwordHash) {
        super(passwordHash);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendText(exchange, 200, "Moved: " + source + " -> " + target);
        } catch (Exception e) {
            sendText(exchange, 500, "Move failed: " + e.getMessage());
        }
    }
