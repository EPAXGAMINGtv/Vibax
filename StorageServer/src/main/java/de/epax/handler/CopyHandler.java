...
public class CopyHandler extends AuthenticatedHandler implements HttpHandler {

    public CopyHandler(String passwordHash) {
        super(passwordHash);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendText(exchange, 200, "Copied: " + source + " -> " + target);
        } catch (Exception e) {
            sendText(exchange, 500, "Copy failed: " + e.getMessage());
        }
    }
