...
public class GetAllMetadataHandler extends JsonHandler implements HttpHandler {

    public GetAllMetadataHandler(String passwordHash) {
        super(passwordHash);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            Map<String, String> metadata = FileManager.getAllMetadata(path);
            sendJson(exchange, 200, metadata);
        } catch (Exception e) {
